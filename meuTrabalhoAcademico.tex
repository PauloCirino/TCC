...
\usepackage{subeqnarray}		% Permite subnumeracao de ções
...
\include{./02-elementos-textuais/SoftwareLivre}	  
\include{./02-elementos-textuais/LinguagemR}
\include{./02-elementos-textuais/AprendizadoDeMaquinas}	
\include{./02-elementos-textuais/EstatisticasDeTeste}
\include{./02-elementos-textuais/OPacote}
